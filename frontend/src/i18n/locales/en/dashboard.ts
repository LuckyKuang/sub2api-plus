export default {
  ...
  usage: {
    ...
    timingUnavailableNonStream: 'Non-streaming request has no measurable generation interval',
    timingUnavailableIncomplete: 'Request did not complete',
    timingUnavailableCompaction: 'Compaction result has no observable token deltas',
    timingUnavailableNoTokens: 'No token deltas or last-token timing observed',
    timingUnavailableInvalid: 'Invalid timing data',
    timingUnavailableShort: 'Generation interval below 300ms or output below 8 tokens',
