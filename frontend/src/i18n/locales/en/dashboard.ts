export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your Sub2API Plus Grok group.',
  ...
  usage: {
    ...
    latencyTps: 'TPS',
    latencyTpsHint: 'Estimated average text output rate: text output tokens divided by elapsed time after the first token; complete requests only.',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
