export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your Sub2API Plus Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your Sub2API Plus Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your Sub2API Plus Grok group.',
        configTomlHint:
  ...
  usage: {
    ...
    latencyFirstImage: 'First Image Data',
    latencyFirstAudio: 'First Audio Data',
    ...
    timingUnavailableNonStream: 'Non-streaming request; TPS uses the decode window (last token − first token)',
    ...
    timingUnavailableShort: 'Low-confidence sample: decode window below 300ms or output below 8 tokens',
    timingUnavailableReason: 'Unavailable reason',
    latencyTpsHint: 'Decode rate: billed text tokens ÷ (last-token time − first-token time). Excludes thinking wait (already shown as First Token) and post-token flush. Incomplete, non-stream, and short decode windows still show a number, with a confidence note.',
	incomplete: 'Incomplete',
	incompleteHint: 'The request ended before a complete terminal result. Displayed usage and cost may be partial.',
	clientDisconnected: 'Client disconnected',
	clientDisconnectedHint: 'The client disconnected after upstream acceptance. Displayed usage and charges come from the usage available during settlement.',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
    ...
    tabs: { usage: 'Usage', errors: 'Error Requests', ranking: 'User Ranking', disconnects: 'Client Disconnects' },
    errors: {
