    ...
    groups: {
      ...
      subscription: {
        ...
        quotaFollowReset: {
          ...
          hint: 'Only OpenAI OAuth accounts bound to this group can be selected. Passive only: the first observed official weekly next-reset time establishes a baseline. After that window expires, a later weekly next-reset time resets this group once; small timestamp drift does not. This does not affect account routing.',
