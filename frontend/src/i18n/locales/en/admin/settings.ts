export default {
    settings: {
      ...
      outboundIdentity: {
        ...
        effectiveAccount: 'Effective account identity',
        client: 'Client identifier', version: 'Client version', source: 'Source',
        headers: 'Outbound identity headers', advanced: 'Advanced identity settings',
        inherit: 'Inherit global default', builtin: 'Use default mapping',
        inheritHint: 'Leave blank for the project default. The client version and UA are generated together; SDK and protocol versions retain their own definitions.',
        defaults: 'Default account identity mapping',
      ...
      features: {
        ...
        modelPlaza: {
		  ...
		  publicExposureWarning: 'Anonymous access exposes non-exclusive group names, model availability, pricing, and rate multipliers. Exclusive groups remain hidden from anonymous visitors.',
        ...
        riskControl: {
          ...
          disconnectBan: 'Ban repeated client disconnects',
          disconnectBanHint: 'Disable ordinary users after consecutive accepted requests are cancelled before completion. Administrators are exempt, and a successful request resets the count.',
          disconnectBanThreshold: 'Consecutive disconnect threshold',
          disconnectBanThresholdHint: 'Allowed range: 1-1000. Default: 10.',
      ...
      tencentCaptcha: {
        ...
        region: 'Site',
        regionCn: 'China site',
        regionIntl: 'International site',
        regionHint: 'Determines the frontend script and the server endpoint. China and international sites use separate account systems; this must match the Captcha console where the app was created.',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Sub2API Plus end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Sub2API Plus end-user login',
      ...
      defaults: {
        ...
        asyncImageUserImagesPerMinute: 'Async Image Outputs Per User / 60 Seconds',
        asyncImageUserImagesPerMinuteHint: 'Generation and edit tasks share this limit across all API keys and groups, counted by requested output images; 0 = unlimited. Takes effect immediately.',
      ...
      gatewayForwarding: {
        ...
        openaiCodexVersionEffective: 'Currently effective: {version} ({source})',
        openaiCodexVersionSourceOverride: 'pinned',
        openaiCodexVersionSourceSynced: 'synced',
        openaiCodexVersionSourceCompiled: 'built-in',
        openaiCodexVersionSyncedValue: 'Currently synced: {version}',
        openaiCodexVersionCheckedAt: 'Last checked: {time}',
        openaiCodexVersionNeverChecked: 'Not synced yet',
        openaiCodexVersionSyncNow: 'Sync now',
        openaiCodexVersionSyncing: 'Syncing…',
        openaiCodexVersionSyncSuccess: 'Synced to {version}',
        openaiCodexVersionSyncUnchanged: 'Checked, still {version}',
        openaiCodexVersionSyncFailed: 'Sync failed: {error}',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Sub2API Plus',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Sub2API Plus orders; the upstream type is sent as EasyPay type.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Sub2API Plus',
        useTls: 'Use TLS',
      ...
      openaiFastPolicy: {
        ...
        userIdsHint: 'Type any part of a user email to search. Leave empty to apply to all Sub2API Plus users. Selected users match requests from their API keys and take precedence over global rules.',
      ...
      openaiExperimentalScheduler: {
        ...
        oauthRatePriorityDescription: 'When a group contains both API Key and OAuth accounts, this rate is used to order OAuth accounts alongside the manually configured API Key account rates.',
