export default {
    ...
    usageAlert: {
      ...
      menu: 'Usage Alert',
      description:
        'Push usage windows on a report cron; optionally watch a threshold with a separate cron and cooldown. Quiet hours are supported. Multiple rules can run together on the server.',
      rulesTitle: 'Alert rules',
      addRule: 'Add rule',
      emptyRules: 'No rules yet. Click “Add rule” to start.',
      ruleLabel: 'Rule {n}',
      enabled: 'Enable this rule',
      enabledHint: 'When enabled, the backend pushes usage reports on the report cron',
      channel: 'Bot type',
      channelWecom: 'WeCom bot',
      channelFeishu: 'Feishu bot',
      channelCustom: 'Custom webhook',
      webhookUrl: 'Webhook URL',
      webhookPlaceholderWecom: 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...',
      webhookPlaceholderFeishu: 'https://open.feishu.cn/open-apis/bot/v2/hook/...',
      webhookPlaceholderCustom: 'https://hooks.example.com/usage-alert',
      webhookHintWecom: 'WeCom group bot webhook. Stored and displayed in full (not redacted).',
      webhookHintFeishu: 'Feishu / Lark custom bot webhook. Stored and displayed in full.',
      webhookHintCustom: 'Any HTTPS URL; receives JSON (title / markdown / account fields, etc.).',
      cronExpression: 'Report cron',
      cronPlaceholder: '0 * * * *',
      cronHelp: 'Standard 5-field cron for scheduled usage-window reports',
      cronTooltipTitle: 'Cron examples:',
      cronTooltipMeaning: 'Defines when the scheduled report is pushed.',
      cronTooltipExampleHourly: '0 * * * *: every hour on the hour',
      cronTooltipExampleDaily: '0 9 * * *: every day at 09:00',
      thresholdEnabled: 'Enable usage threshold',
      thresholdEnabledHint: 'When on, a separate watch cron checks utilization and alerts once per cooldown window.',
      thresholdPercent: 'Threshold (%)',
      thresholdPercentHint: 'Integer from 1–99. When hit, the message title becomes a threshold alert.',
      thresholdWatchCron: 'Threshold watch cron',
      thresholdWatchCronPlaceholder: '*/5 * * * *',
      thresholdWatchCronHint: 'Required. Backend fetches usage on this schedule to evaluate the threshold.',
      cooldownSeconds: 'Cooldown (seconds)',
      cooldownSecondsHint: 'Required. After an alert, skip repeats and usage fetches until the cooldown ends.',
      quietHours: 'Quiet hours',
      quietHoursHint: 'Optional. During these daily windows, neither report nor threshold watch fetches usage. Overnight ranges are supported (e.g. 22:00:00-06:00:00).',
      quietHoursAdd: 'Add range',
      quietHoursStart: 'Start',
      quietHoursEnd: 'End',
      quietHoursEmpty: 'No quiet hours (allowed all day)',
      forceProbe: 'Force upstream probe',
      forceProbeHint: 'When enabled, each run actively probes upstream quota first; when off, local snapshots are preferred.',
      nextRun: 'Next report',
      lastRun: 'Last report',
      thresholdNextRun: 'Next threshold watch',
      lastThresholdAlert: 'Last threshold alert',
      lastError: 'Last error',
      testSend: 'Test send',
      testing: 'Sending...',
      saveSuccess: 'Usage alert config saved',
      testSuccess: 'Pushed to the configured bot'
    },
    ...
    usage: {
	  ...
	  allUsageSources: 'All usage sources',
	  usageSourceExact: 'Upstream exact',
      ...
      disconnectEvents: {
        hint: 'Lifecycle metadata only. Consecutive outcomes are scoped to the sanitized inbound client session.',
        ...
        upstreamExact: 'Upstream exact',
        partial: 'Partial',
        estimated: 'Estimated',
        reconciled: 'Reconciled',
        autoBanned: 'Auto-banned',
        consecutiveCount: 'Consecutive cancellations',
        threshold: 'Threshold',
        ...
        empty: 'No client disconnect lifecycle events found',
        failedToLoad: 'Failed to load client disconnect lifecycle events'
      },
      tokenRanking: {
