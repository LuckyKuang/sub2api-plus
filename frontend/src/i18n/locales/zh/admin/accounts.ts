export default {
    accounts: {
      ...
      dataExportPassword: '管理员密码',
      dataExportTotpCode: '双因素验证码',
      ...
      openai: {
        ...
        oauthSessionSharingDesc: '此策略仅适用于 OpenAI OAuth 账号：仅允许关联分组中的 API Key 使用该 OAuth 账号，并在这些分组间续接同一上游会话；不会影响 OpenAI API Key 账号。',
        ...
        codexEnvironmentTimezoneNone: '未设置（跟随代理/全局）',
        ...
        codexEgressCountry: 'Codex 出口国家代码',
        codexEgressCountryNone: '未设置（跟随代理/全局）',
        codexEgressCountryDesc:
          '该账号出站声明的出口国家（ISO 3166-1 alpha-2，如 US）。优先于代理标注与全局默认；留空依次跟随。',
      ...
      grok: {
        ...
        ttsTextLabel: 'TTS 文本',
        ttsTextPlaceholder: '例如：Connectivity test.',
        ttsTextDefault: 'Connectivity test.',
