export default {
    ...
    usageAlert: {
      ...
      menu: '用量告警',
      description:
        '按 cron 定时将该账号的用量窗口（5h / 7d）推送到企业微信 / 飞书 / 自定义机器人。可配置多条规则同时生效；开启阈值后仅在使用率达到阈值时告警。任务在服务端执行，不依赖管理员登录态。',
      rulesTitle: '告警规则',
      addRule: '添加规则',
      emptyRules: '暂无规则，点击「添加规则」开始配置。',
      ruleLabel: '规则 {n}',
      enabled: '启用本规则',
      enabledHint: '开启后，后台会按本规则的 cron 自动执行',
      channel: '机器人类型',
