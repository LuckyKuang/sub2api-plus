export default {
  ...
  usage: {
    ...
    timingUnavailableNonStream: '非流式请求，无可测生成区间',
    timingUnavailableIncomplete: '请求未完整结束',
    timingUnavailableCompaction: '压缩结果没有可观测的 Token 增量',
    timingUnavailableNoTokens: '未观测到有效 Token 增量或末 Token 时间',
    timingUnavailableInvalid: '时序数据无效',
    timingUnavailableShort: '生成区间不足 300ms 或输出不足 8 tokens',
