...
func init() {
	...
	usagelogDescFirstOutputKind := usagelogFields[37].Descriptor()
	...
	usagelogDescCompletionStatus := usagelogFields[39].Descriptor()
	...
	usagelogDescUsageSource := usagelogFields[40].Descriptor()
