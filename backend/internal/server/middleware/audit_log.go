...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/accounts/export":                           service.AuditActionAccountsExport,
	...
	"PUT /api/v1/admin/ip-access-control/settings":                 "security.ip_access_control.settings.update",
