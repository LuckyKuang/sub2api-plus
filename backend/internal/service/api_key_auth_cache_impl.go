...
const apiKeyAuthSnapshotVersion = 21 // v21: group profit/five-hour + search/audio/video_model_prices billing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			FiveHourLimitUSD:                apiKey.Group.FiveHourLimitUSD,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			FiveHourLimitUSD:                snapshot.Group.FiveHourLimitUSD,
