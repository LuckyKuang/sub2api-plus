...
const (
	...
	SettingKeyAsyncImageUserImagesPerMinute = "async_image_user_images_per_minute" // 每用户异步生图张数限制（0 = 不限制）
	...
	SettingKeyOpenAICodexLocalGroupQuotaEnabled = "openai_codex_local_group_quota_enabled"
