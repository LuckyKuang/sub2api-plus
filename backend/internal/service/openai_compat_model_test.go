...
func TestForwardAsAnthropic_ReusesOAuthCodexTurnState(t *testing.T) {
	...
	requireOpenAIMessagesCodexIdentity(t, upstream.requests[0], DefaultOpenAICodexUserAgent, "codex_cli_rs")
	...
	requireOpenAIMessagesCodexIdentity(t, upstream.requests[1], DefaultOpenAICodexUserAgent, "codex_cli_rs")
