...
func ProvidePricingRemoteClient(cfg *config.Config) service.PricingRemoteClient {
	return NewPricingRemoteClient(cfg)
}
...
var ProviderSet = wire.NewSet(
	...
	NewGeminiTokenCache,
	NewImageTaskStore,
	NewAsyncImageRateLimitStore,
	NewRedisInvalidationBus,
	NewImageTaskHistoryRepository,
	NewBatchImageQueue,
	...
	NewTotpCache,
	NewAccountExportConfirmationLimiter,
