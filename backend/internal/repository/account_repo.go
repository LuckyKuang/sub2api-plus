...
import (
	...
	dbaccountgroup "github.com/LuckyKuang/sub2api-plus/ent/accountgroup"
	dbgroup "github.com/LuckyKuang/sub2api-plus/ent/group"
	dbpredicate "github.com/LuckyKuang/sub2api-plus/ent/predicate"
	dbproxy "github.com/LuckyKuang/sub2api-plus/ent/proxy"
...
func (r *accountRepository) Update(ctx context.Context, account *service.Account) error {
	return r.updateAccount(ctx, account, account.RateMultiplier)
}
...
func (r *accountRepository) updateLockedAccount(
	...
	extra, err := lockAndMergeAccountExtra(ctx, client, account)
	if err != nil {
		return nil, err
	}
	account.Extra = extra
