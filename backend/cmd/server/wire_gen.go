...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redisInvalidationBus := repository.NewRedisInvalidationBus(redisClient)
	ipAccessControlService := service.ProvideIPAccessControlService(settingRepository, ipAccessControlRepository, redisInvalidationBus)
	...
	openAIOAuthService := service.ProvideOpenAIOAuthService(proxyRepository, openAIOAuthClient, privacyClientFactory, settingService)
	...
	imageStorageSettingService := service.ProvideImageStorageSettingService(settingRepository, secretEncryptor, backupService, imageStorageFactory, redisInvalidationBus, configConfig)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, ipAccessControlMiddleware, compositeRouteResolver, redisClient)
