...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	ipAccessControlService := service.ProvideIPAccessControlService(settingRepository, ipAccessControlRepository, redisClient)
	...
	imageStorageSettingService := service.ProvideImageStorageSettingService(settingRepository, secretEncryptor, backupService, imageStorageFactory, redisClient, configConfig)
	...
	asyncImageRateLimiter := service.NewAsyncImageRateLimiter(redisClient, settingService)
