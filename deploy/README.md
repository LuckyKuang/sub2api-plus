...
```bash
curl -sSL https://raw.githubusercontent.com/LuckyKuang/sub2api-plus/main/deploy/install.sh | sudo bash -s -- rollback 'v0.1.172+custom.001'
```
...
```bash
sudo ./install.sh rollback 'v0.1.172+custom.001'
```
