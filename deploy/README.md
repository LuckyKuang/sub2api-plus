...
```text
Git/GitHub: v0.1.170+custom.002
GHCR:       ghcr.io/luckykuang/sub2api-plus:v0.1.170-custom.002
```
...
```bash
curl -sSL https://raw.githubusercontent.com/LuckyKuang/sub2api-plus/main/deploy/install.sh | sudo bash -s -- install --version 'v0.1.170+custom.002'
```
...
```bash
sudo ./install.sh install --version 'v0.1.170+custom.002'
```
